...
export default function Test() {
  ...
  const greeting = 'Для заполнения полей - используйте ------ enter ----- чтобы приступить к созданию резюме произнесите начать ------------ если хотите вернуться в личный кабинет ----- скажите назад  ------- чтобы отчистить поле ввода ------- скажите отмена ';
